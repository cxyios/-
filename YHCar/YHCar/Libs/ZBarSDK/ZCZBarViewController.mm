...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64,kWinSize.width , self.view.frame.size.height-64-100)];
        bgImageView.contentMode=UIViewContentModeTop;
        bgImageView.clipsToBounds=YES;
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 300, kWinSize.width, 40)];
    ...
    _line = [[UIImageView alloc] initWithFrame:CGRectMake((kWinSize.width
                                                          -200)/2, 50, 220, 2)];
  ...
  //下方相册
    UIImageView*scanImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, bgImageView.frame.size.height+64, kWinSize.width, 100)];
    ...
    //假导航
    UIImageView*navImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kWinSize.width, 64)];
    navImageView.image=[UIImage imageNamed:@"qrcode_scan_bar.png"];
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel*titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(kWinSize.width/2-32,20 , 64, 44)];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
        ...
        _line.frame = CGRectMake((kWinSize.width
                                  -200)/2, 50+250, 220, 2);
